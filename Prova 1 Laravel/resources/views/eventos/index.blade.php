...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <button type="button" class="btn btn-lg btn-block btn-primary" data-toggle="modal" data-target="#ModalNovoEvento">Cadastrar Evento</button>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="favoritesModalLabel">Cadastrar Evento</h4>
                </div>
    ...
    {{-- <div class="modal fade" id="ModalEditalEvento" tabindex="-1" role="dialog" aria-labelledby="favoritesModalLabel">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                    <h4 class="modal-title" id="favoritesModalLabel">Editar</h4>
                </div>
